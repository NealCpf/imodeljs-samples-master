...
import {
  ...
  ItemList, StagePanel, SyncUiEventId, ToolItemDef, ToolWidget, UiFramework, Widget, WidgetState, Zone, ZoneState,
} from "@bentley/ui-framework";
import * as React from "react";
import { saveImage, SaveImageTool } from "../../tools/SaveImageTool";
...
class SampleToolWidget extends React.Component {
  ...
  private createCustomToolItemDef(): ToolItemDef {
    return new ToolItemDef({
      toolId: SaveImageTool.toolId,
      iconSpec: SaveImageTool.iconSpec,
      execute: () => {
